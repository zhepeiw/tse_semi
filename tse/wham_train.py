        ...
        with open(save_file, "w") as results_csv:
            ...
            with tqdm(test_loader, dynamic_ncols=True) as t:
                for i, batch in enumerate(t):
                    ...
                    with torch.no_grad():
                        predictions, targets, _, enr_emb = self.compute_forward(
                    ...
                    sisnr_baseline, _ = self.compute_objectives(mixture_signal, targets, enr_emb, None, sb.Stage.TEST)
...
if __name__ == "__main__":
    ...
    # Data preparation
    from data.wham_data_utils import create_wham_tse_csv
    for part in ['train', 'valid', 'test']:
        run_on_main(
            create_wham_tse_csv,
            kwargs={
                "wham_dir": hparams['{}_wham_folder'.format(part)],
                "wsj_dir": hparams['wsj_folder'],
    ...
    if hparams["dynamic_mixing"]:
        ...
        train_data = static_data_prep(hparams, 'train')
